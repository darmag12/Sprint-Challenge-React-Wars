...
React.JS is not an opinionated library; it lets you use JavaScript and other JavaScript libraries the way you want by writing it in JSX.

- [x] What does it mean to _think_ in react? To be able to build an app by giving each component a task

- [x] Describe state.  State is internal to a component.
  

- [x] Describe props. props are passed to a component
